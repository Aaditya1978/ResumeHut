...
export default function Minimal({ user }) {
          ...
          <Grid container spacing={3}>
              ...
              >
                ...
                <Grid item xs={12} sm={3} md={3}>
                  <TextField
                    ...
                    onChange={(e) => {
                      const newProject = [...data.projects];
                      newProject[ind].start = e.target.value;
                      setData({ ...data, projects: newProject });
                    }}
                    variant="standard"
                    required
                ...
                <Grid item xs={12} sm={3} md={3}>
                  <TextField
                    ...
                    onChange={(e) => {
                      const newProject = [...data.projects];
                      newProject[ind].end = e.target.value;
                      setData({ ...data, projects: newProject });
                    }}
                    variant="standard"
                    required
            ...
            {data.awards.map((award, ind) => (
              ...
              >
                <Grid item xs={12} sm={3} md={3}>
                  <TextField
                    ...
                    onChange={(e) => {
                      ...
                      newAward[ind].institute = e.target.value;
                ...
                <Grid item xs={12} sm={3} md={3}>
                  <TextField
                    label="Enter Honour Name"
                    value={award.name}
                    onChange={(e) => {
                      const newAward = [...data.awards];
                      newAward[ind].name = e.target.value;
                      setData({ ...data, awards: newAward });
                    }}
                    variant="standard"
                    required
                ...
                <Grid item xs={12} sm={3} md={3}>
                  <TextField
                    label="Enter Time of Receiving"
                    value={award.time}
                    onChange={(e) => {
                      const newAward = [...data.awards];
                      newAward[ind].time = e.target.value;
                      setData({ ...data, awards: newAward });
                    }}
                    variant="standard"
                    required
                ...
                <Grid item xs={12} sm={3} md={3}>
                  <TextareaAutosize
                    ...
                    onChange={(e) => {
                      const newAward = [...data.awards];
                      newAward[ind].description = e.target.value;
                      setData({ ...data, awards: newAward });
                    }}
                    required
                    style={{ width: 200 }}
